...
<!-- HEADER -->
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:000000,100:DC143C&height=200&section=header&text=MEFKUZ&fontSize=80&fontColor=FFFFFF&animation=fadeIn&fontAlignY=35&desc=Security%20Researcher%20%7C%20Developer&descSize=20&descAlignY=55"/>

<!-- TYPING SVG -->
[![Typing SVG](https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=22&duration=3000&pause=1000&color=DC143C&center=true&vCenter=true&random=false&width=500&lines=Security+Researcher;OSINT+Specialist;Python+Developer;Building+SenfoniScan)](https://git.io/typing-svg)

<!-- STATS LINE -->
<p>
  <img src="https://komarev.com/ghpvc/?username=mefkuz&style=for-the-badge&color=DC143C&labelColor=000000" alt="profile views"/>
  <a href="https://github.com/mefkuz?tab=followers">
    <img src="https://img.shields.io/github/followers/mefkuz?style=for-the-badge&logo=github&color=DC143C&labelColor=000000"/>
  </a>
</p>
...
class Mefkuz:
    def __init__(self):
        ...
        self.focus = ["Cybersecurity", "OSINT", "Automation", "Tool Development"]
        self.motto = "Hack the planet."
    
    def current_projects(self):
        return [
            "SenfoniScan  → Next-Gen OSINT & Recon Framework",
            "Senfoni Chat → Encrypted Messaging Platform",
            "Senfoni Bot  → Discord Server Management",
        ]
```
